...
class LIADashboardSupabaseUser extends BaseAuthUser {
  LIADashboardSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> lIADashboardSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = LIADashboardSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
